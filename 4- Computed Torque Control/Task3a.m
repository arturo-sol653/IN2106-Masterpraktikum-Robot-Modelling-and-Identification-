...
h1=plot(task3.time, task3.Data(:,1), 'b', 'LineWidth', 1.3); hold on;
h2=plot(task3.time, task3.Data(:,2), 'r', 'LineWidth', 1.3);
h3=plot(task3.time, task3.Data(:,3), 'm', 'LineWidth', 1.3); 
h4=plot(task3.time, task3.Data(:,4), 'c', 'LineWidth', 1.3);
